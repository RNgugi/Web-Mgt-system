...
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Inmates</li>
...
<div class="agile-grids">	
				<!-- tables -->
				 ...
				 <table id="table-max-height" class="max-height">
                  ...
                  $query = mysqli_query($conn,"SELECT * FROM writers WHERE status= 'active' ") or die(mysqli_error($conn));
                ...
                ?> <tr>
						...
						<td><?php echo "$inmateid";?></td>
						<td><?php echo "$yob";?></td>
						<td><?php echo "$crime";?></td>
						<td><?php echo "$termlength";?></td>

						<td> <?php echo "$activity";?> </td></tr>
