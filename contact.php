                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul id="nav">
                                ...
                                <li class="current-item"><a href="#">Letters</a></li>
                            </ul>
                ...
                <div class="col-12 col-lg-8">
                    <div class="uza-contact-form mb-80">
                        <div class="contact-heading mb-50">
                            <h4>Thank you for taking your time. <br>Please fill out the form below and show your loved one they still matter.</h4>
                        </div>
                        <form action="feedback.php" method="POST" id="formid">
                            <div class="row">
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control mb-30" name="relationship" placeholder="Relationship with Inmate">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control mb-30" name="message" rows="11" cols="80" placeholder="Message"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <input type="submit" value="Submit" name="submit" class="btn uza-btn btn-3 mt-15">
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-between">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-footer-widget mb-80">
                        <!-- Widget Title -->
                        <h4 class="widget-title">Visiting Hours</h4>
                        <p class="mb-0">Mon - Fri: 12:00 - 3:00 <br>
                                Closed on Weekends <br> Lawyer Visits: Office Hours  </p>
                        <!-- Copywrite Text -->
                        <div class="copywrite-text mb-30">
                            <p>&copy; Copyright 2019 <a href="#">SubGroup 9</a>.</p>
                        </div>
