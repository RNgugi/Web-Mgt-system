...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM accowners WHERE username = :username";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO accowners (username, password) VALUES (:username, :password)";
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Warden &mdash; Sign Up</title>
    ...
    <div class="main" style="background-image: none;">
        ...
        <section class="signup">
            ...
            <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                ...
                <input type="text" placeholder="Email" name="username" class="form-control" value="<?php echo $username; ?>">
